def get_template_by_dataset(dataset_name):
    ...
    if(dataset_name=='arxiv'):
        ...
        template_l = "It is a book in the history domain, and its title and content are: \n\n"
        template_r = ".\n\nQuestion: Based on the title and content provided, the category of the book is \"___\" (answer in one word).\nAnswer: \""
    elif dataset_name == "amazonratings":
        template_l = "It is a product on Amazon, and user comments are: \n\n"
        template_r = ".\n\nQuestion: Based on the comments provided, the score of the product is \"___\" (answer in one word).\nAnswer: \""
    else:

...
def get_args():
    ...
    parser.add_argument('--dataset_name', type=str, nargs='+', default=['cora'],help='Choose the dataset of pretrainor downstream task')
    ...
    parser.add_argument('--normal_split', default=False, action='store_true', help='Use normal split for dataset')

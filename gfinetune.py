from graphadapter.finetune_utils import finetune,load_data_with_prompt_embedding,set_random_seed
import numpy as np
import argparse
import torch
def run_exp(args):
    ...
    for split in range(0,5):
        data=load_data_with_prompt_embedding(args.dataset_name, args.mode)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_name', type=str, help='dataset to be used', default='cora',
                        choices=['cora', 'bookhis', 'amazonratings', 'arxiv'])
    ...
    parser.add_argument('--mode', type=str, default='finetune', help='mode of running',choices=['finetune','zero', 'few'])

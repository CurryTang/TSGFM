...
class MAG240M(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        self.train_idx = torch.cat([self.train_idx, self.val_idx, self.test_idx])
...
class GNN(LightningModule):
    def __init__(self, model: str, in_channels: int, out_channels: int,
        ...
        self.train_acc = Accuracy(task="multiclass", num_classes=153)
        self.val_acc = Accuracy(task="multiclass", num_classes=153)
        self.test_acc = Accuracy(task="multiclass", num_classes=153)
    ...
    def training_step(self, batch, batch_idx: int):
        ...
        self.log('train_acc', self.train_acc, prog_bar=True, on_step=False,
                 on_epoch=True)
        torch.save(batch, f'/mnt/home/chenzh85/graphlang/PyGFM/prodigy/experiments/batchsave/batch_{batch_idx}.pt')
        return train_loss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sizes', type=str, default='10-5')

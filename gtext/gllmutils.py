...
def get_sampled_nodes(data_obj, sample_num = -1):
    if hasattr(data_obj, "test_masks"):
...
def load_mapping():
    ...
    bookhis_mapping = {'World': 'World', 'Americas': 'Americas', 'Asia': 'Asia', 'Military': 'Military', 'Europe': 'Europe', 'Russia': 'Russia', 'Africa': 'Africa', 'Ancient Civilizations': 'Ancient Civilizations', 'Middle East': 'Middle East', 'Historical Study & Educational Resources': 'Historical Study & Educational Resources', 'Australia & Oceania': 'Australia & Oceania', 'Arctic & Antarctica': 'Arctic & Antarctica'}
    amazonratings_mapping = {'5score': '5score', '4.5 score': '4.5 score', '4 score': '4 score', '3.5 score': '3.5 score', '0-3 score': '0-3 score'}
    
    return arxiv_mapping, citeseer_mapping, pubmed_mapping, cora_mapping, products_mapping, bookhis_mapping, amazonratings_mapping
def few_shot():
    few_shot_samples = {
        "top1": {
            ...
            """
            Product Description:
            Praise for Forgotten Voices of the Blitz and the Battle for Britain:Anyone who wants to learn about human courage and human endurance should read this account. It is more powerful than any drama, more convincing than any fiction. Peter Ackroyd; Title: Forgotten Voices of the Somme: The Most Devastating Battle of the Great War in the Words of Those Who Survived
            Task:
            There are following categories:
            ['World', 'Americas', 'Asia', 'Military', 'Europe', 'Russia', 'Africa', 'Ancient Civilizations', 'Middle East', 'Historical Study & Educational Resources', 'Australia & Oceania', 'Arctic & Antarctica']
            Which category does this book belong to?
            ...
            """
            Product Description:
            Seymour\'s books remain the most entertaining and informative histories about baseball\'s position in American culture."--H. Gehrig Coleman, University of TexasWith Baseball: The Golden Age, Dr. Harold Seymour--the man whom Sports Illustrated has called \'the Edward gibbon of baseball history\'--continues his monumental multi-volume study of the sport. This second volume explores the both glorious and grievous era when the game truly captured the American imagination with such legendary figures at Ty Cobb and Babe Ruth and also appalled fans with startling scandals. Beginning with the formation of the two major leagues in 1903, Seymour examines the changes in the organization of professional baseball from an unwieldy three-man commission to the strong one-man rule of Judge Kenesaw Mountain Landis.; Title: Baseball: The Golden Age (Oxford Paperbacks)
            Task:
            There are following categories:
            ['World', 'Americas', 'Asia', 'Military', 'Europe', 'Russia', 'Africa', 'Ancient Civilizations', 'Middle East', 'Historical Study & Educational Resources', 'Australia & Oceania', 'Arctic & Antarctica']
            Which category does this book belong to?
            ...
            """
            Product Description:
            ANGUS KONSTAM was formerly the Curator of Weapons in the Royal Armouries at the Tower of London, and he now combines a freelance museum consultancy business with a career as a historian and writer. He is the author of over 20 books for this series.; Title: Hampton Roads 1862: Clash of the Ironclads (Praeger Illustrated Military History
            Task:
            There are following categories:
            ['World', 'Americas', 'Asia', 'Military', 'Europe', 'Russia', 'Africa', 'Ancient Civilizations', 'Middle East', 'Historical Study & Educational Resources', 'Australia & Oceania', 'Arctic & Antarctica']
            Which category does this book belong to?
            ...
            Task:
            There are following categories:
            ["5score", "4.5 score", "4 score", "3.5 score", "0-3 score"]
            Output the most 1 possible category of this book as a python list, like ['XX']
            Result:
            ['4.5 score']
            """,
            ...
            3.5 score, "3.5 score average ratings users are neutral about the products."
            0-3 score,"0-3 score bad ratings users think the products are bad."
            Name of the products: Another Thin Man
            Task:
            There are following categories:
            ["5score", "4.5 score", "4 score", "3.5 score", "0-3 score"]
            Output the most 1 possible category of this book as a python list, like ['XX']
            ...
            3.5 score, "3.5 score average ratings users are neutral about the products."
            0-3 score,"0-3 score bad ratings users think the products are bad."
            Name of the products: The International Children's Bible
            Task:
            There are following categories:
            ["5score", "4.5 score", "4 score", "3.5 score", "0-3 score"]
            Output the most 1 possible category of this book as a python list, like ['XX']

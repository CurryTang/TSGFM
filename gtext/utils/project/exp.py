...
from gtext.utils.basics import init_env_variables, save_cfg, WandbExpLogger, print_important_cfg, init_path, \
    get_important_cfg, logger
from gtext.utils.pkg.distributed import get_rank, get_world_size, init_process_group

proj_path = "~/nips/MyOFA/"
PROJ_CONFIG_FILE = '~/nips/MyOFA/conf/proj.yaml'

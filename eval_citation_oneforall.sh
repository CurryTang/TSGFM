...
function run_repeats {
    ...
    main="python3 run_cdm.py ${cfg_overrides}"
...
run_repeats "--override /mnt/home/chenzh85/graphlang/PyGFM/MyOFA/eval_ctation_oneforall.yaml d_multiple 1,1,1,1,1 d_min_ratio 1,1,1,1,1 model noparam"
run_repeats "--override /mnt/home/chenzh85/graphlang/PyGFM/MyOFA/eval_ctation_oneforall.yaml d_multiple 1,1,1,1,1 d_min_ratio 1,1,1,1,1 model ofa JK last"

...
for d in "chemhiv" "chempcba" "muv" "toxcast" "bace" "bbbp" 
do 
    python run_cdm.py task_names $d model ofamlp exp_name $d num_epochs 30
done

python3 run_cdm.py task_names "chemhiv,chempcba,tox21,muv,toxcast,bace,bbbp" num_epochs 30 model ofamlp exp_name "all_molmlp"
